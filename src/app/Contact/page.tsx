...
export default function Contact(){
    ...
    return (
        ...
        <div className="grid md:grid-cols-3 items-start gap-4 max-md:gap-12 max-w-6xl mx-auto py-6 bg-[#fbf7ef] font-[sans-serif]">
        <div className="px-4">
          <h2 className="text-gray-800 text-xl font-semibold">Contact Information</h2>
          ...
          <div className="space-y-8 mt-8">
            <div className="flex">
              ...
              <div className="ml-4">
                ...
                <p className="text-xs mt-1 text-gray-500">Chat with our team to help.</p>
                <p className="text-sm mt-4">malikrimsha686@gmail.com</p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                ...
                <p className="text-xs mt-1 text-gray-500">Monday to sunday.</p>
                <p className="text-xs mt-1 text-gray-500">24 Hours AAvailable.</p>
                <p className="text-sm mt-4">+92323023515</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-800 rounded-3xl md:col-span-2 p-8">
          <h2 className="text-xl text-yellow-300 font-semibold">Product or Service Inquiry</h2>
          <p className="text-sm text-gray-400 mt-2 leading-relaxed">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project and provide help.</p>
          ...
          <form>
            <div className="space-y-4 mt-8">
              ...
              <textarea placeholder="Write Message"
                className="px-2 pt-3 bg-transparent text-gray-200 font-medium w-full text-sm border-b border-gray-400 focus:border-yellow-300 outline-none"></textarea>
            </div>
  
            <button type="button"
              className="mt-8 flex items-center justify-center text-sm rounded-md px-4 py-2.5 text-gray-800 bg-yellow-400 hover:bg-yellow-500">
